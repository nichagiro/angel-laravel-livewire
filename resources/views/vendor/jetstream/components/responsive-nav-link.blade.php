...
$classes = ($active ?? false)
            ? "block pl-3 pr-4 py-2 border-l-4 border-$color-400 text-base font-medium text-$color-700 bg-$color-50 focus:outline-none focus:text-$color-800 focus:bg-$color-100 focus:border-$color-700 transition"
